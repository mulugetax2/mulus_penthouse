...
broom_closet = create_room("broom closet", "You enter a closet with nothing in it")
...
create_exit(hallway, broom_closet, "you see a broom closet.")
create_exit(broom_closet, hallway, "Go back into the hallway.")
