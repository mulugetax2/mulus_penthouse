...
##
living_room = create_room("your in the living room where you see 10 tv's and 20 mini fridges filled with tacos") 
lounge = create_room("lounge", "you're in a lounge just chilling")
gaming_room = create_room("gaming room", "you enter a gaming room and see a bunch of consoles and controllers")
...
outside = create_room("outside", "You walk out the door! You are now outside.", ends_game=True)

##
# Let's connect them together.
# It's not a very fun adventure, but it's simple.
##
create_exit(living_room, hallway, "A door leads into the hall.")
# If you want doors to work in both directions; you have to do that yourself.
create_exit(hallway, living_room, "Go back into the living room.")
create_exit(hallway, gaming_room, "you see a gaming room.")
create_exit(gaming_room, hallway, "Go back into the hallway.")
